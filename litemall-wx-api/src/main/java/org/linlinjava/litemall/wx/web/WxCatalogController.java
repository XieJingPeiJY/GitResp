...
public class WxCatalogController {
     ...
     */
    @GetMapping("index")
    public Object index(Integer id) {            //分页（分类）默认进入页的商品
     ...
     */
    @GetMapping("current")
    public Object current(@NotNull Integer id) {      ////分页（分类）点击事件后索引页查询的商品
        // 当前分类
...
//        while (it.hasNext()) {
//            Map.Entry<String, Object> entry = it.next();
//            System.out.println("索引页》》》key = " + entry.getKey() + ", value = " + entry.getValue());
//        }
